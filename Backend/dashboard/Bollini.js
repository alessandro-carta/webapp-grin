...
export async function getBollini(presidente) {
    const queryBollini = `
        SELECT Bollini.idBollino AS "id", Bollini.Erogato AS "erogato", Regolamenti.AnnoAccademico AS "annoaccademico", CorsiDiStudio.Nome AS "corsodistudio", Bollini.Richiesta AS "richiesta", Regolamenti.idRegolamento AS "regolamento"
